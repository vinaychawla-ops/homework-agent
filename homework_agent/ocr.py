...
_HANDWRITING_PROMPT = (
    ...
    "Transcribe every line on the page, including the student's answer even "
    "when it appears on its own line starting with 'Ans:', 'Answer:' or "
    "'A1:' - never skip the answer lines. "
